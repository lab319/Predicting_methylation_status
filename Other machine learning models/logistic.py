...
def logistic(traindata,trainlabel,testdata,testlabel):
    print("start training logisticregression")
    clf=LogisticRegression(penalty='l1', tol=0.0001, C=0.01, fit_intercept=True, 
                               intercept_scaling=1, class_weight=None, random_state=None, 
                               solver='liblinear', max_iter=94, multi_class='ovr', verbose=0, 
                               warm_start=False)
...
logistic(X_trainnn,Y_train,X_testtt,Y_test)
